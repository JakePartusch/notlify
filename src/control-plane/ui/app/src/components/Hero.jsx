  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="max-w-4xl mx-auto text-5xl font-medium tracking-tight font-display text-slate-900 sm:text-7xl">
        Deployments{" "}
        <span className="relative text-cyan-600 whitespace-nowrap">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
      ...
      <p className="max-w-2xl mx-auto mt-6 text-lg tracking-tight text-slate-700">
        Most website deployment services are complex, or closed-source. Notlify
        is neither of these things, and hopes to bring transparency and
        simplicity back to your website deployments.
      </p>
      <div className="flex justify-center mt-10 gap-x-6">
        ...
        >
          ...
          <span className="ml-3">GitHub source</span>
        </Button>
      </div>
    </Container>
  );
